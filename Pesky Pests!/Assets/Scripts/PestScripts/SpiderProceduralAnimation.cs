...
public class SpiderProceduralAnimation : MonoBehaviour
{
    ...
    public float idkwhatthisdoes = 2f;
    ...
    void FixedUpdate()
    {
        ...
        {
            Vector3 targetPoint = desiredPositions[indexToMove] + Mathf.Clamp(velocity.magnitude * velocityMultiplier, 0.0f, idkwhatthisdoes) * (desiredPositions[indexToMove] - legTargets[indexToMove].position) + velocity * velocityMultiplier;
